...
// trackAction emits an action-started event and returns the matching
// completion emitter for the caller to defer:
//
...
func (a *Agent) CleanupDone(ctx context.Context) {
	defer a.trackAction(CategoryCleanup, "", "Cleaning up merged/closed PRs", "Cleanup complete")()
