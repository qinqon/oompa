// Package gh wraps the GitHub REST API behind the Client interface,
// with etag caching, dry-run, and GitHub App authentication support.
package gh
...
// countCommitsCap bounds pagination in CountCommitsSince: counting stops once
// the total exceeds it, so returned values above the cap are lower bounds.
// Callers comparing the result against a threshold must keep that threshold
// <= countCommitsCap (pkg/agent's rebase quiet threshold is 5).
const countCommitsCap = 5

// Client defines all GitHub operations needed by the agent.
...
// RESTClient implements Client using go-github.
type RESTClient struct {
	client *github.Client
}

// NewRESTClient creates a new client authenticated with the given token.
...
// NewRESTClientFromHTTPClient creates a new client using a custom HTTP client
// (e.g., one with a GitHub App installation transport).
func NewRESTClientFromHTTPClient(httpClient *http.Client) (*RESTClient, error) {
...
func (g *RESTClient) GetPRReviewComments(ctx context.Context, owner, repo string, prNumber int, sinceID int64) ([]ReviewComment, error) {
...
func (g *RESTClient) GetIssueComments(ctx context.Context, owner, repo string, issueNumber int, sinceID int64) ([]ReviewComment, error) {
...
func (g *RESTClient) GetPRState(ctx context.Context, owner, repo string, prNumber int) (string, error) {
...
func (g *RESTClient) AddIssueComment(ctx context.Context, owner, repo string, issueNumber int, body string) error {
...
func (g *RESTClient) AddLabel(ctx context.Context, owner, repo string, issueNumber int, label string) error {
...
func (g *RESTClient) ListPRsByHead(ctx context.Context, owner, repo, headOwner, branch string) ([]PR, error) {
	head := branch
	if headOwner != "" {
...
func (g *RESTClient) AddPRCommentReaction(ctx context.Context, owner, repo string, commentID int64, reaction string) error {
...
func (g *RESTClient) AddIssueCommentReaction(ctx context.Context, owner, repo string, commentID int64, reaction string) error {
...
func (g *RESTClient) GetCheckRuns(ctx context.Context, owner, repo, ref string) ([]CheckRun, error) {
...
// GetCheckRunLog.
func (g *RESTClient) GetCommitStatuses(ctx context.Context, owner, repo, ref string) ([]CheckRun, error) {
	var runs []CheckRun
...
func (g *RESTClient) AssignIssue(ctx context.Context, owner, repo string, issueNumber int, user string) error {
...
func (g *RESTClient) UnassignIssue(ctx context.Context, owner, repo string, issueNumber int, user string) error {
...
func (g *RESTClient) GetPRMergeable(ctx context.Context, owner, repo string, prNumber int) (string, error) {
	pr, _, err := g.client.PullRequests.Get(ctx, owner, repo, prNumber)
	if err != nil {
...
func (g *RESTClient) GetPRHeadCommitDate(ctx context.Context, owner, repo string, prNumber int) (time.Time, error) {
	pr, _, err := g.client.PullRequests.Get(ctx, owner, repo, prNumber)
	if err != nil {
...
func (g *RESTClient) CreatePR(ctx context.Context, owner, repo, title, body, head, base string) (int, error) {
...
func (g *RESTClient) HasLinkedPR(ctx context.Context, owner, repo string, issueNumber int) (bool, error) {
...
func (g *RESTClient) GetPR(ctx context.Context, owner, repo string, prNumber int) (PR, error) {
	pr, _, err := g.client.PullRequests.Get(ctx, owner, repo, prNumber)
	if err != nil {
...
func (g *RESTClient) IsPRBehind(ctx context.Context, owner, repo string, prNumber int) (bool, error) {
	pr, _, err := g.client.PullRequests.Get(ctx, owner, repo, prNumber)
	if err != nil {
...
func (g *RESTClient) CreateIssue(ctx context.Context, owner, repo, title, body string, labels []string) (int, error) {
...
func (g *RESTClient) SearchIssues(ctx context.Context, query string) ([]Issue, error) {
	var allIssues []Issue
...
func (g *RESTClient) GetAuthenticatedUser(ctx context.Context) (login, name, email string, err error) {
...
func (g *RESTClient) GetLatestReleaseSHA(ctx context.Context, owner, repo string) (string, error) {
...
func (g *RESTClient) CountCommitsSince(ctx context.Context, owner, repo string, since time.Time) (int, error) {
